...
import assets, {messagesDummyData} from "../assets/assets.ts";
    ...
    return selectedUser ? (
        <div className='h-full overflow-scroll relative backdrop-blur-lg'>
            <div className='flex items-center gap-3 py-3 mx-4 border-b border-stone-500'>
                ...
                <img onClick={() => setSelectedUser(null)} src={assets.help_icon} alt=""
            ...
            <div className='flex flex-col h-[calc(100%-120px)] overflow-y-scroll p-3 pb-6'>
                    ...
                    <div key={index} className={`flex items-end gap-2 justify-end
                        ...
                        <div className='text-center text-xs'>
                            <img src={msg.senderId === '680f50e4f10f3cd28382ecf9'
                                ? assets.avatar_icon : assets?.avatar_girl_icon} alt="" className='w-7 rounded-full'/>
                ...
                <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3'>
                    ...
                    <img
                        ...
                        src={assets.send_icon} alt="" className='w-11 cursor-pointer'/>
                </div>
            </div>
        </div>
    ) : (
